...
<head>
	...
	<link rel="icon" href="<?= base_url('/public/admin/assets/img/icon.ico'); ?>" type="image/x-icon"/>

	<!-- Fonts and icons -->
	<script src="<?= base_url('/public/admin/assets/js/plugin/webfont/webfont.min.js'); ?>"></script>
  <script>
	WebFont.load({
		google: { families: ["Lato:300,400,700,900"] },
		custom: {
			families: ["Flaticon", "Font Awesome 5 Solid", "Font Awesome 5 Regular", "Font Awesome 5 Brands", "simple-line-icons"],
			urls: ["http://localhost/BOUTIQUEHELENGIRL/public/admin/assets/css/fonts.css"]
		},
		active: function () {
		...
		<div class="main-header">
			...
			<div class="logo-header" data-background-color="blue">
				...
				<a href="index.html" class="logo">
					<img src="<?= base_url('/public/admin/assets/img/logo.svg'); ?>" alt="navbar brand" class="navbar-brand">
				</a>
			...
			<!-- Navbar Header -->
			<nav class="navbar navbar-header navbar-expand-lg" data-background-color="moradobajito">
					...
					<ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
								...
								<li>
									<div class="message-notif-scroll scrollbar-outer">
										<div class="notif-center">
											<a href="#">
												<div class="notif-img"> 
													<img src="<?= base_url('/public/admin/assets/img/jm_denis.jpg'); ?>" alt="Img Profile">
												</div>
											...
											<a href="#">
												<div class="notif-img"> 
													<img src="<?= base_url('/public/admin/assets/img/chadengle.jpg'); ?>" alt="Img Profile">
												</div>
												<div class="notif-content">
											...
											<a href="#">
												<div class="notif-img"> 
													<img src="<?= base_url('/public/admin/assets/img/mlane.jpg'); ?>" alt="Img Profile">
												</div>
												<div class="notif-content">
											...
											<a href="#">
												<div class="notif-img"> 
													<img src="<?= base_url('/public/admin/assets/img/talha.jpg'); ?>" alt="Img Profile">
												</div>
												<div class="notif-content">
								...
								<li>
									<div class="notif-scroll scrollbar-outer">
										<div class="notif-center">
											...
											<a href="#">
												<div class="notif-img"> 
													<img src="<?= base_url('/public/admin/assets/img/profile2.jpg'); ?>" alt="Img Profile">
												</div>
												<div class="notif-content">
													<span class="block">
						...
						<li class="nav-item dropdown hidden-caret">
							<a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#" aria-expanded="false">
								<div class="avatar-sm">
									<img src="<?= base_url('/public/admin/assets/img/profile.jpg'); ?>" alt="..." class="avatar-img rounded-circle">
								</div>
							</a>
							<ul class="dropdown-menu dropdown-user animated fadeIn">
								<div class="dropdown-user-scroll scrollbar-outer">
									<li>
										<div class="user-box">
											<div class="avatar-lg"><img src="<?= base_url('/public/admin/assets/img/profile.jpg'); ?>" alt="image profile" class="avatar-img rounded"></div>
											<div class="u-text">
												<h4>Hizrian</h4>
						...
						<li class="nav-item active">
							...
							<div class="collapse" id="dashboard">
								<ul class="nav nav-collapse">
									<li>
										<a href="<?= base_url('listaempleadonuevo'); ?>">
